...
#undef CONFIG_BOOTARGS
	...
	#define	CONFIG_BOOTARGS "console=ttyATH0,115200 board=domino root=31:03 rootfstype=squashfs,jffs2 noinitrd mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env),1280k(kernel),14656k(rootfs),64k(nvram),64k(art)ro,15936k@0x50000(firmware)"
...
#define CONFIG_EXTRA_ENV_SETTINGS	"uboot_addr=0x9F000000\0" \
									"uboot_name=uboot_for_domino.bin\0" \
									...
									"firmware_name=openwrt-domino.bin\0" \
									"lf=" \
										"if ping $serverip; then " \
									...
									"lc=" \
										...
										"cp.b 0x80060000 0x9fff1000 0xf000\0" \
									SILENT_ENV_VARIABLE
