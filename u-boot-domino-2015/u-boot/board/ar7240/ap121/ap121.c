...
#define GPIO_WAN_LED_BIT 17 //this is the wan
#define GPIO_WAN_LED_ON 0


void wlan_led_toggle(void){
	unsigned int gpio;
...
void led_toggle(void){
	...
	gpio ^= 1 << GPIO_WLAN_LED_BIT;
#elif defined(CONFIG_FOR_GL_INET) || defined(CONFIG_FOR_DOMINO)
	gpio ^= 1 << GPIO_WLAN_LED_BIT;
#else
...
void wlan_led_on(void){
	unsigned int gpio;
	gpio = ar7240_reg_rd(AR7240_GPIO_OUT);
	SETBITVAL(gpio, GPIO_WLAN_LED_BIT, GPIO_WLAN_LED_ON);
	ar7240_reg_wr(AR7240_GPIO_OUT, gpio);
}
void wlan_led_off(void){
	unsigned int gpio;
	gpio = ar7240_reg_rd(AR7240_GPIO_OUT);
	SETBITVAL(gpio, GPIO_WLAN_LED_BIT, !GPIO_WLAN_LED_ON);
	ar7240_reg_wr(AR7240_GPIO_OUT, gpio);
...
#elif defined(CONFIG_FOR_DOMINO)
	// TODO: check GPIO config for DOMINO
	ar7240_reg_wr(AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | 0x22001));
#elif defined(CONFIG_FOR_DRAGINO_V2) || defined(CONFIG_FOR_MESH_POTATO_V2)
